        ...
        <Grid item xs={12} lg={6}>
          <Box className={classes.content}>
            <Box className={classes.inner}>
                <Typography className={classes.title} variant="h4">Live Lessons with expert JEE teachers</Typography>
                <Typography className={classes.desc} variant="h6">
                  Attend live online classes to learn, revise, analyse mock tests and prepare for JEE with experts
                </Typography>
